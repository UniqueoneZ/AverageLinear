...
# Mamba Settings
parser.add_argument('--c_layers', type=int, default=0, help='d_state of mamba')
parser.add_argument('--num_layers', type=int, default=1, help='layers inside transoformer block')
parser.add_argument('--num_layers_trans', type=int, default=1, help='transformer emb layers number')
parser.add_argument('--num_layers_linear', type=int, default=1, help='linearr emb layers number')
parser.add_argument('--emb_dropout', type=float, default=0, help='dropout rate for emb layer')
...
if __name__ == '__main__':
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_ft{}_sl{}_pl{}_dm{}_dr{}_rt{}_dw{}_sl{}_{}_{}_{}_{}_{}_{}_{}_{}'.format(
                args.model_id,
                args.model,
                args.data,
                args.features,
                ...
                args.c_layers,
                args.num_layers,
                args.num_layers_linear,
                args.num_layers_trans,
                args.emb_dropout,
                ii)
